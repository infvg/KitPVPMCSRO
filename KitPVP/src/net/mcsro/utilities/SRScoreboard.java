...
public class SRScoreboard {
	...
	public SRScoreboard(String title) {
	...
	public void add(String text) {
		add(ChatColor.translateAlternateColorCodes('&', text), null);
	}
	...
	public void build() {
		...
		for (Map.Entry<String, Integer> text : scores.entrySet()) {
			...
			OfflinePlayer player = Bukkit.getOfflinePlayer(team.getValue() + ChatColor.translateAlternateColorCodes('&', "&r"));
